...
{
	if(str::empty(s)) return defaultNavi;
	else if(wcsicmp(s, L"goto"       ) == 0) return NaviGoto;
	else if(wcsicmp(s, L"goto-always") == 0) return NaviGotoAlways;
	else if(wcsicmp(s, L"open"       ) == 0) return NaviOpen;
	else if(wcsicmp(s, L"open-always") == 0) return NaviOpenAlways;
	else if(wcsicmp(s, L"append"     ) == 0) return NaviAppend;
	else if(wcsicmp(s, L"reserve"    ) == 0) return NaviReserve;
	else if(wcsicmp(s, L"switch"     ) == 0) return NaviSwitch;
	else if(wcsicmp(s, L"replace"    ) == 0) return NaviReplace;
	else return defaultNavi;
}
