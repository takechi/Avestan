...
namespace
{
	static PCWSTR TypeToName(TypeCode typecode)
	{
		switch(typecode)
		{
		case TypeNull		: return L"Null";
		case TypeBool		: return L"Bool";
		case TypeSint8		: return L"Sint8";
		case TypeUint8		: return L"Uint8";
		case TypeSint16		: return L"Sint16";
		case TypeUint16		: return L"Uint16";
		case TypeSint32		: return L"Sint32";
		case TypeUint32		: return L"Uint32";
		case TypeSint64		: return L"Sint64";
		case TypeUint64		: return L"Uint64";
		case TypeSize		: return L"Size";
		case TypePoint		: return L"Point";
		case TypeRect		: return L"Rect";
		case TypeColor		: return L"Color";
		case TypeUnknown	: return L"String";	// すべてのオブジェクトは文字列として保存する
		default				: return null;
		}
	}
...
#define N2T(what)	{ L#what , Type##what },
	static const Name2Type N2T_BEGIN[] =
	{
		N2T( Bool		)
		N2T( Color		)
		N2T( Null		)
		...
		N2T( Sint8		)
		N2T( Size		)
		{ L"String" , TypeUnknown }, // N2T( String		)
		N2T( Uint16		)
		N2T( Uint32		)
		N2T( Uint64		)
		N2T( Uint8		)
...
#undef N2T
	...
	inline static bool equals(PCWSTR lhs, size_t cch, PCWSTR rhs) throw()
	{
		return str::compare(lhs, rhs, cch) == 0;
	}
	...
	static void WriteVariant(IXMLWriter* sax, const variant& var, PCWSTR name)
	{
		...
		if(!type)
			throw ArgumentError(string::load(IDS_ERR_XMLMSG_TYPECODE, name, (string)var), var.type);
