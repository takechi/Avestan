...
public:
	...
	HRESULT		set_RenameExtension(bool value)	{ m_RenameExtension = value; return S_OK; }
...
//	HRESULT SelectAll()	{ return MimicKeyDown('A', ModifierControl); }
	...
	HRESULT GetSortKey(int* column, bool* ascending)
	{
		return afx::ListView_GetSortKey(m_wndList, column, ascending);
	}
	HRESULT SetSortKey(int column, bool ascending)
	{
		return afx::ListView_SetSortKey(m_wndList, column, ascending);
	}
