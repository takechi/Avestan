...
class Module : public Object {
 public:
  ...
  Module(const char* name, PyMethodDef methods[]) : Object(Py_InitModule(const_cast<char*>(name), methods)) {}
  Module(const char* name, PyMethodDef methods[], const char* doc)
      : Object(Py_InitModule3(const_cast<char*>(name), methods, const_cast<char*>(doc))) {}
