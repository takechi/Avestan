...
#pragma warning( disable : 4100 ) // warning C4100: 'argument' : 引数は関数の本体部で 1 度も参照されません。
#pragma warning( disable : 4127 ) // warning C4127: 条件式が定数です。
#pragma warning( disable : 4201 ) // warning C4201: 非標準の拡張機能が使用されています : 無名の構造体または共用体です。
#pragma warning( disable : 4290 ) // warning C4290: C++ の例外の指定は無視されます。関数が __declspec(nothrow) でないことのみ表示されます。
...
#define _WTL_NO_WTYPES			// CSize, CPoint, CRect ではなく、ATLのクラスを使用するため。
...
typedef float	REAL32;	///< 32bit浮動小数.
typedef double	REAL64;	///< 64bit浮動小数.
