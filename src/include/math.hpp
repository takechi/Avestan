...
const REAL32 E = 2.7182818284590452354f;    ///< 自然対数の底(REAL32).
const REAL32 PI = 3.14159265358979323846f;  ///< 円周率(REAL32).
                                            // const REAL64 E = 2.7182818284590452354; ///< 自然対数の底(REAL64).
                                            // const REAL64 PI = 3.14159265358979323846; ///< 円周率(REAL64).
